...
2. **Existing `.claude/wiki/`.** If present, determine its shape:
   ...
   - If it contains [Karpathy LLMwiki](https://gist.github.com/karpathy/442a6bf555914893e9891c11519de94f)-style files (`_log.md` + `_schema.md`) but no `_hot.md` — offer migration (Step 3, "existing-wiki path").
   - Anything else — offer migration (Step 3, "existing-wiki path").
